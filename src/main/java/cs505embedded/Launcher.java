...
public class Launcher {
    ...
    //test
    //curl -H "X-Auth-API-Key: 12508607" http://localhost:9000/api/checkmydatabase


    public static DBEngine dbEngine;
    public static final String API_SERVICE_KEY = "12508607"; //Change this to your student id
